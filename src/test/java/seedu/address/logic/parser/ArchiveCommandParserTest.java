...
public class ArchiveCommandParserTest {
    ...
    @Test
    public void parse_validIndex_returnsArchiveCommand() {
        assertParseSuccess(parser, "1", new ArchiveCommand(INDEX_FIRST_PERSON));
    }

    @Test
    public void parse_emptyArgs_returnsArchiveAllCommand() {
        assertParseSuccess(parser, "", new ArchiveCommand());
    }

    @Test
    public void parse_whitespaceArgs_returnsArchiveAllCommand() {
        assertParseSuccess(parser, "   ", new ArchiveCommand());
    }
}
